...
exports.run = function () {
    ...
    var fullPath = path.normalize(path.join(process.cwd(), opts.arg('APP_PATH'))),
        ...
        skeletonName = exports.skeletonPrefix + (opts.get('type') || exports.defaultSkeleton)
    ...
    var copyTemplate = function (src, dst) {
        ...
        // Replace values in the filename
        dst = new Template(dst).substitute(subs)
